						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset($publishedProduct->productImage)}}" height='300' width='200' alt="" class="pro-image-front">
									<img src="{{asset($publishedProduct->productImage)}}" height='300' width='200' alt="" class="pro-image-back">
